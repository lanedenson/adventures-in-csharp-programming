    ...
    public partial class Adventure {
        ...
        public Adventure() {
            ...
            * */
            ...
            _map = new RoomList {
                /*                  N                   S                   W                   E               Up              Down   */
                { Rm.GoreStreet, new Room("Gore Street", "a narrow, twisty street that smells of decay. There is a sign on the wall",
                ...
                { Rm.DeadEnd, new Room("Dead End", "a sinister little street that leads nowhere.\r\nThere is a button on the wall",
                                ...
                                new ThingList()) },
                { Rm.OpiumTerrace, new Room("Opium Terrace", "a dark, dripping terrace illuminated by a hissing gas lamp. There is a sign on the wall",
                ...
                { Rm.DaggerStreet, new Room("Dagger Street", "a long, winding street with exits to North and South. There is a narrow alleyway to the west." +
                                ...
                                new ThingList()) },
                { Rm.RipperMews, new Room("Ripper Mews", "a delightful little street filled with the scent of gardenia . There is a sign on the wall",
            ...
            _map[Rm.Balcony].AddThing(new ContainerThing("slot", "A lever fixed to the wall", false, false, false, true, null));
